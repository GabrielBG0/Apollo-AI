print("starting alphaFormater.py")

compiledDataset = ""
for i in range(2332):
    with open("Scraper/dataset/"+ str(i) + ".txt", "r", encoding="utf-8") as file:
...
print("all files foramted, saving in to dataset")

open("datasets/a/dataset.txt", "w", encoding="utf-8").write(compiledDataset)
